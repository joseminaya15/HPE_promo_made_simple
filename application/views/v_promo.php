        ...
        <section id="promo" class="section">
            <div class="mdl-container">
                ...
                <div class="col-xs-12 p-0 promociones">
                    <div class="mdl-card mdl-card-promocion">
                        <div class="mdl-header">
                            <h2>Promo Base (Includes Virtual Licenses)</h2>
                            <p>Valid until April 30</p>
                        </div>
                        <div class="mdl-contenido">
                            <div class="contenido">
                                <div class="promocion">
                                    <h2 class="title">Commercial Objective</h2>
                                    <p>Take advantage of aggressive pricing of market product bestsellers (HW, SW, PointNext)</p>
                                </div>
                                <div class="promocion">
                                    <h2 class="title">Commercial Objective</h2>
                                    <p>Take advantage of aggressive pricing of market product bestsellers (HW, SW, PointNext)</p>
                            ...
                            <div class="imagenes text-center">
                                <img class="imagen-promocion" src="<?php echo RUTA_IMG?>promo/promo1.png">
                                <img class="imagen-promocion" src="<?php echo RUTA_IMG?>promo/promo1.png">
                                <img class="imagen-promocion" src="<?php echo RUTA_IMG?>promo/promo1.png">
